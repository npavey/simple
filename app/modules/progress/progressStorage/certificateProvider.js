define([
  ...
  "templateSettings",
  "helpers/idToUuid"
], function(urlProvider, httpWrapper, auth, templateSettings, idToUuid) {
  "use strict";

  function CertificateProvider() {
    this.getCertificateUrl = function(
      courseId,
      templateId,
      logoUrl
    ) {
  ...
  function getCulture() {
    return templateSettings.languages.selected === "ua"
      ? "uk"
      : templateSettings.languages.selected;
  }
